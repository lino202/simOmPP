...
parser.add_argument('--meshPath',type=str, default="F:/Electra/electra_sims/Biovad/Paper/fassina_05_thick/tissue.inp")
...
parser.add_argument('--resExcel', type=str, help='max CV in cm/s', default="F:/Electra/electra_sims/Biovad/Paper/fassina_05_thick/results.xlsx")
