function [qrs_sim, t_sim, qrs_exp, t_exp, qrs_time, t_time] = function_processSampleECG_HE_byWave(root_path, sample, experiments_names, result_names, dt_sim, pecg_name, results_folder_name, alignment)
