...
experiments_names = {'sample8', 'sample9', 'sample10', 'sample11', 'sample12'};
result_names      = {'sample8/results_mi_baseline_3000ms', ...
                    'sample9/results_mi_baseline_3000ms', ...
                    'sample10/results_mi_baseline_3000ms', ...
                    'sample11/results_mi_baseline_3000ms', ...
                    'sample12/results_mi_baseline_3000ms'};
n_experiments     = 5;
fs_sim            = 1/0.00025; %0.25 ms, in Hz
cutoff            = 40;

ecg_path_results = append(root_path, 'ecg_results/');
...
load(append(root_path, result_names{1}, '/', 'pECG.mat'));
nLeads        = size(pECG,2);
...
for i=1:n_experiments
    load(append(root_path, result_names{i}, '/', 'pECG.mat'));
    pECG_tot_ecgs(:,:,i) = pECG;
    pECG_tot_time(:,i) = time;
end
...
% end
% set(fig, 'Position', [0, 0, 2000, 1200]); % [left, bottom, width, height]
% exportgraphics(gcf,append(ecg_path_results, 'simulations_final.png'),'Resolution',400);
% 
% 
% 
% for i=1:nLeads
